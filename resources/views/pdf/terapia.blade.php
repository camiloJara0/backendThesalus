...
<body>
    ...
    <div style="margin-bottom: 20px;">
        <div style="margin-bottom: 20px; font-size:10px;">
            <h3 style="background-color: #f0f0f0; padding: 8px; border: 1px solid #ddd; text-align: center;">Evolucion (condición inicial, objetivo de la sesión, técnica método y/o intervención que se realice, condicion final)</h3>
            <div style="text-align: justify; padding: 10px; border: 1px solid #ddd;">
                Numero de Sesion : {{ $terapia->sesion }}
            </div>
            <div style="text-align: justify; padding: 10px; border: 1px solid #ddd;">
                Fecha y Hora: {{ $terapia->fecha }} , {{ $terapia->hora }}
            </div>
            <div style="text-align: justify; padding: 10px; border: 1px solid #ddd;">
                {{ $terapia->evolucion }}
            </div>

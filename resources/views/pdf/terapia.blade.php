...
<body>
    ...
    <div style="margin-bottom: 20px;">
        ...
        <table style="width: 100%; font-size: 10px; border-collapse: collapse;">
            <tr style="background-color: #f0f0f0;">
                <th style="padding: 8px; border: 1px solid #ddd; text-align: left;">Objetivos de la intervecion terapeutica</th>
            </tr>
                <tr>
                    <td style="padding: 8px; border: 1px solid #ddd;">{{ $terapia->objetivos }}</td>
                </tr>
        </table>
    </div>
    ...
    <div style="margin-bottom: 20px;">
        <table style="width: 100%; font-size: 10px; border-collapse: collapse;">
            <tr style="background-color: #f0f0f0;">
                <th style="padding: 8px; border: 1px solid #ddd; text-align: left;">Sesión</th>
                <th style="padding: 8px; border: 1px solid #ddd; text-align: left;">Fecha y Hora</th>
                <th style="padding: 8px; border: 1px solid #ddd; text-align: left;">Evolucion (condición inicial, objetivo de la sesión, técnica método y/o intervención que se realice, condicion final)</th>
            </tr>
                <tr>
                    <td style="padding: 8px; border: 1px solid #ddd;">{{ $terapia->sesion }}</td>
                    <td style="padding: 8px; border: 1px solid #ddd;">{{ $terapia->fecha }} | {{ $terapia->hora }}</td>
                    <td style="padding: 8px; border: 1px solid #ddd;">{{ $terapia->evolucion }}</td>
                </tr>
        </table>
    </div>
